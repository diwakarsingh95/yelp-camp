...
const index = async (req, res) => {
  ...
  res.render("campgrounds", { campgrounds, authPage: false });
};

const newForm = (req, res) => {
  res.render("campgrounds/new", { authPage: false });
};
...
const showCampground = async (req, res, next) => {
  ...
  res.render("campgrounds/show", { campground, authPage: false });
};
...
const editForm = async (req, res) => {
  ...
  res.render("campgrounds/edit", { campground, authPage: false });
};
